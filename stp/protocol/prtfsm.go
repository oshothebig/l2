...
const (
	...
	PrtEventFdWhileEqualZeroAndRstpVersionAndNotLearnAndNotForwardAndSelectedAndNotUpdtInfo
	PrtEventReRootedAndRbWhileEqualZeroAndRstpVersionAndNotLearnAndNotForwardAndSelectedAndNotUpdtInfo
